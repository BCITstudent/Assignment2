class Note {
  ...
  let FirstNote = new Note("Note one", "Here is my first note.");
  let SecondNote = new Note("Note two", "Here is my second note.");
  let NoteArray = [FirstNote, SecondNote];
